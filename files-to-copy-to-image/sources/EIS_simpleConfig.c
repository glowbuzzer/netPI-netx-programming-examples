...
int main(int argc, char* argv[])
{
  ...
  while( (lRet = stat("/opt/cifx/deviceconfig/FW/channel0/R160H000.nxf",&buffer)) != 0) {
    ...
    if( system("dpkg -i ./firmwares/netpi-eis-2.12.5.0.deb") == -1) {
      printf("Installing the firmware failed. Check if firmware 'netpi-eis-2.12.5.0.deb' package is located in folder './firmwares'(relative path to demo app).\n");
      return 0;
    }
  }
